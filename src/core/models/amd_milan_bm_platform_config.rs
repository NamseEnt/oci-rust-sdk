...
impl AmdMilanBmPlatformConfig {
    ...
    pub fn set_numa_nodes_per_socket(mut self, value: Option<AmdMilanBmPlatformConfigNumaNodesPerSocket>) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(mut self, value: AmdMilanBmPlatformConfigNumaNodesPerSocket) -> Self {
