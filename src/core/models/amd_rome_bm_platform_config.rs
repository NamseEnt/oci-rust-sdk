...
impl AmdRomeBmPlatformConfig {
    ...
    pub fn set_numa_nodes_per_socket(mut self, value: Option<AmdRomeBmPlatformConfigNumaNodesPerSocket>) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(mut self, value: AmdRomeBmPlatformConfigNumaNodesPerSocket) -> Self {
