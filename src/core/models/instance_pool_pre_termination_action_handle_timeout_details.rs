...
pub struct InstancePoolPreTerminationActionHandleTimeoutDetails {
    ...
    pub preserve_block_volume_mode: InstancePoolPreTerminationActionHandleTimeoutDetailsPreserveBlockVolumeMode,

    /// Whether the boot volume should be preserved after termination.
    pub preserve_boot_volume_mode: InstancePoolPreTerminationActionHandleTimeoutDetailsPreserveBootVolumeMode,
}
...
impl InstancePoolPreTerminationActionHandleTimeoutDetails {
    ...
    pub fn set_preserve_block_volume_mode(mut self, value: InstancePoolPreTerminationActionHandleTimeoutDetailsPreserveBlockVolumeMode) -> Self {
        self.preserve_block_volume_mode = value;
        self
    }

    /// Set preserve_boot_volume_mode
    pub fn set_preserve_boot_volume_mode(mut self, value: InstancePoolPreTerminationActionHandleTimeoutDetailsPreserveBootVolumeMode) -> Self {
