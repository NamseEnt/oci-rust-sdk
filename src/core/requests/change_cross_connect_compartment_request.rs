...
pub struct ChangeCrossConnectCompartmentRequest {
    ...
    pub change_cross_connect_compartment_details: ChangeCrossConnectCompartmentDetails,
...
impl ChangeCrossConnectCompartmentRequest {
    /// Create a new ChangeCrossConnectCompartmentRequest with required fields
    pub fn new(required: ChangeCrossConnectCompartmentRequestRequired) -> Self {
        Self {
