...
/// Required fields for DetachVolumeRequest
pub struct DetachVolumeRequestRequired {
    /// The OCID of the volume attachment.
    pub volume_attachment_id: String,
}

impl DetachVolumeRequest {
    /// Create a new DetachVolumeRequest with required fields
    pub fn new(required: DetachVolumeRequestRequired) -> Self {
        Self {
