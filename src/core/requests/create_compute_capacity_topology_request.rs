...
pub struct CreateComputeCapacityTopologyRequest {
    /// Details for creating a new compute capacity topology.
    pub create_compute_capacity_topology_details: CreateComputeCapacityTopologyDetails,
...
impl CreateComputeCapacityTopologyRequest {
