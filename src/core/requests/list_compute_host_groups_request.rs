...
pub struct ListComputeHostGroupsRequest {
...
/// Required fields for ListComputeHostGroupsRequest
pub struct ListComputeHostGroupsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListComputeHostGroupsRequest {
    /// Create a new ListComputeHostGroupsRequest with required fields
    pub fn new(required: ListComputeHostGroupsRequestRequired) -> Self {
        Self {
