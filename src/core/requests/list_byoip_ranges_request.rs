...
pub struct ListByoipRangesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListByoipRangesRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListByoipRangesRequestSortOrder>,
}


/// Required fields for ListByoipRangesRequest
pub struct ListByoipRangesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListByoipRangesRequest {
    /// Create a new ListByoipRangesRequest with required fields
    pub fn new(required: ListByoipRangesRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListByoipRangesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListByoipRangesRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListByoipRangesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListByoipRangesRequestSortOrder) -> Self {
