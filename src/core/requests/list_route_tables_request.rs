...
/// Required fields for ListRouteTablesRequest
pub struct ListRouteTablesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListRouteTablesRequest {
    /// Create a new ListRouteTablesRequest with required fields
    pub fn new(required: ListRouteTablesRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListRouteTablesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListRouteTablesRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListRouteTablesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListRouteTablesRequestSortOrder) -> Self {
