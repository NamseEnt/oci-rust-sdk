...
pub struct ListNetworkSecurityGroupsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListNetworkSecurityGroupsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListNetworkSecurityGroupsRequestSortOrder>,
...
impl ListNetworkSecurityGroupsRequest {
    /// Create a new ListNetworkSecurityGroupsRequest
    pub fn new() -> Self {
        Self {
            compartment_id: None,
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListNetworkSecurityGroupsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }
    ...
    pub fn with_sort_by(mut self, value: ListNetworkSecurityGroupsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListNetworkSecurityGroupsRequestSortOrder) -> Self {
...
impl Default for ListNetworkSecurityGroupsRequest {
    fn default() -> Self {
        Self::new()
    }
}
