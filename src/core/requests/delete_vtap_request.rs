...
impl DeleteVtapRequest {
    /// Create a new DeleteVtapRequest with required fields
    pub fn new(required: DeleteVtapRequestRequired) -> Self {
        Self {
