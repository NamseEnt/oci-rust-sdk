...
pub struct ListCrossConnectLocationsRequest {
...
/// Required fields for ListCrossConnectLocationsRequest
pub struct ListCrossConnectLocationsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListCrossConnectLocationsRequest {
    /// Create a new ListCrossConnectLocationsRequest with required fields
    pub fn new(required: ListCrossConnectLocationsRequestRequired) -> Self {
        Self {
