...
pub struct GetByoipRangeRequest {
...
/// Required fields for GetByoipRangeRequest
pub struct GetByoipRangeRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the {@code ByoipRange} resource containing the BYOIP CIDR block.
    pub byoip_range_id: String,
}

impl GetByoipRangeRequest {
    /// Create a new GetByoipRangeRequest with required fields
    pub fn new(required: GetByoipRangeRequestRequired) -> Self {
        Self {
