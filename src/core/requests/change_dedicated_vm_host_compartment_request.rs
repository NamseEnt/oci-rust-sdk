...
pub struct ChangeDedicatedVmHostCompartmentRequest {
    /// The OCID of the dedicated VM host.
    pub dedicated_vm_host_id: String,

    /// The request to move the dedicated virtual machine host to a different compartment.
    pub change_dedicated_vm_host_compartment_details: ChangeDedicatedVmHostCompartmentDetails,
...
impl ChangeDedicatedVmHostCompartmentRequest {
    /// Create a new ChangeDedicatedVmHostCompartmentRequest with required fields
    pub fn new(required: ChangeDedicatedVmHostCompartmentRequestRequired) -> Self {
        Self {
