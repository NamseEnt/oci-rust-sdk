...
pub struct ListCrossConnectGroupsRequest {
...
/// Required fields for ListCrossConnectGroupsRequest
pub struct ListCrossConnectGroupsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListCrossConnectGroupsRequest {
    /// Create a new ListCrossConnectGroupsRequest with required fields
    pub fn new(required: ListCrossConnectGroupsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListCrossConnectGroupsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListCrossConnectGroupsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListCrossConnectGroupsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListCrossConnectGroupsRequestSortOrder) -> Self {
