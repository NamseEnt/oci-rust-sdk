...
pub struct ListComputeGlobalImageCapabilitySchemaVersionsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeGlobalImageCapabilitySchemaVersionsRequestSortBy>,
...
impl ListComputeGlobalImageCapabilitySchemaVersionsRequest {
