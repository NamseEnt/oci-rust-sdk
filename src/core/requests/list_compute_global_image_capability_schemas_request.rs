...
pub struct ListComputeGlobalImageCapabilitySchemasRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeGlobalImageCapabilitySchemasRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListComputeGlobalImageCapabilitySchemasRequestSortOrder>,
}

impl ListComputeGlobalImageCapabilitySchemasRequest {
    /// Create a new ListComputeGlobalImageCapabilitySchemasRequest
    pub fn new() -> Self {
        Self {
            compartment_id: None,
...
impl Default for ListComputeGlobalImageCapabilitySchemasRequest {
    fn default() -> Self {
        Self::new()
    }
}
