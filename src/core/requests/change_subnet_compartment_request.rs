...
pub struct ChangeSubnetCompartmentRequest {
    ...
    pub change_subnet_compartment_details: ChangeSubnetCompartmentDetails,
...
impl ChangeSubnetCompartmentRequest {
    /// Create a new ChangeSubnetCompartmentRequest with required fields
    pub fn new(required: ChangeSubnetCompartmentRequestRequired) -> Self {
        Self {
            subnet_id: required.subnet_id,

            change_subnet_compartment_details: required.change_subnet_compartment_details,
