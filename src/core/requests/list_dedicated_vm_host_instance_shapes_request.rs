...
pub struct ListDedicatedVmHostInstanceShapesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub dedicated_vm_host_shape: Option<String>,
...
/// Required fields for ListDedicatedVmHostInstanceShapesRequest
pub struct ListDedicatedVmHostInstanceShapesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListDedicatedVmHostInstanceShapesRequest {
    /// Create a new ListDedicatedVmHostInstanceShapesRequest with required fields
    pub fn new(required: ListDedicatedVmHostInstanceShapesRequestRequired) -> Self {
        Self {
            compartment_id: required.compartment_id,

            availability_domain: None,

            dedicated_vm_host_shape: None,
    ...
    pub fn set_dedicated_vm_host_shape(mut self, value: Option<String>) -> Self {
    ...
    /// Set dedicated_vm_host_shape (unwraps Option)
    pub fn with_dedicated_vm_host_shape(mut self, value: impl Into<String>) -> Self {
        self.dedicated_vm_host_shape = Some(value.into());
        self
    }
