...
pub struct CreateClusterNetworkRequest {
    /// Cluster network creation details
    pub create_cluster_network_details: CreateClusterNetworkDetails,
...
impl CreateClusterNetworkRequest {
    /// Create a new CreateClusterNetworkRequest with required fields
    pub fn new(required: CreateClusterNetworkRequestRequired) -> Self {
        Self {
