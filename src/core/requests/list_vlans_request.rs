...
impl ListVlansRequest {
    /// Create a new ListVlansRequest with required fields
    pub fn new(required: ListVlansRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListVlansRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListVlansRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListVlansRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListVlansRequestSortOrder) -> Self {
