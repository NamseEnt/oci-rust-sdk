...
pub struct ListRemotePeeringConnectionsRequest {
...
/// Required fields for ListRemotePeeringConnectionsRequest
pub struct ListRemotePeeringConnectionsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListRemotePeeringConnectionsRequest {
    /// Create a new ListRemotePeeringConnectionsRequest with required fields
    pub fn new(required: ListRemotePeeringConnectionsRequestRequired) -> Self {
        Self {
