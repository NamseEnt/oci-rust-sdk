...
pub struct UpdateVirtualCircuitRequest {
    ...
    pub update_virtual_circuit_details: UpdateVirtualCircuitDetails,
...
impl UpdateVirtualCircuitRequest {
    /// Create a new UpdateVirtualCircuitRequest with required fields
    pub fn new(required: UpdateVirtualCircuitRequestRequired) -> Self {
        Self {
