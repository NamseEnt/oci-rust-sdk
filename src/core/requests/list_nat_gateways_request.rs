...
pub struct ListNatGatewaysRequest {
...
/// Required fields for ListNatGatewaysRequest
pub struct ListNatGatewaysRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListNatGatewaysRequest {
    /// Create a new ListNatGatewaysRequest with required fields
    pub fn new(required: ListNatGatewaysRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListNatGatewaysRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListNatGatewaysRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListNatGatewaysRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListNatGatewaysRequestSortOrder) -> Self {
