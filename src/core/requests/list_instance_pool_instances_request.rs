...
pub struct ListInstancePoolInstancesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListInstancePoolInstancesRequestSortBy>,
...
impl ListInstancePoolInstancesRequest {
    /// Create a new ListInstancePoolInstancesRequest with required fields
    pub fn new(required: ListInstancePoolInstancesRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListInstancePoolInstancesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }
    ...
    pub fn with_sort_by(mut self, value: ListInstancePoolInstancesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListInstancePoolInstancesRequestSortOrder) -> Self {
