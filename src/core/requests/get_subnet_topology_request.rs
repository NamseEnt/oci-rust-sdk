...
pub struct GetSubnetTopologyRequest {
    ...
    pub access_level: Option<GetSubnetTopologyRequestAccessLevel>,
...
/// Required fields for GetSubnetTopologyRequest
pub struct GetSubnetTopologyRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
...
impl GetSubnetTopologyRequest {
    /// Create a new GetSubnetTopologyRequest with required fields
    pub fn new(required: GetSubnetTopologyRequestRequired) -> Self {
        Self {
    ...
    /// Set access_level
    pub fn set_access_level(mut self, value: Option<GetSubnetTopologyRequestAccessLevel>) -> Self {
    ...
    pub fn with_access_level(mut self, value: GetSubnetTopologyRequestAccessLevel) -> Self {
