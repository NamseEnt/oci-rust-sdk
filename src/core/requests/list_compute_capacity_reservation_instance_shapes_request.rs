...
pub struct ListComputeCapacityReservationInstanceShapesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeCapacityReservationInstanceShapesRequestSortBy>,
...
impl ListComputeCapacityReservationInstanceShapesRequest {
    /// Create a new ListComputeCapacityReservationInstanceShapesRequest with required fields
    pub fn new(required: ListComputeCapacityReservationInstanceShapesRequestRequired) -> Self {
        Self {
