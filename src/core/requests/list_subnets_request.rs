...
/// Required fields for ListSubnetsRequest
pub struct ListSubnetsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListSubnetsRequest {
    /// Create a new ListSubnetsRequest with required fields
    pub fn new(required: ListSubnetsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListSubnetsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListSubnetsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListSubnetsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListSubnetsRequestSortOrder) -> Self {
