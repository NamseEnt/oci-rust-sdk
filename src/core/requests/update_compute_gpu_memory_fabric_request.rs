...
pub struct UpdateComputeGpuMemoryFabricRequest {
    /// The OCID of the compute GPU memory fabric.
    pub compute_gpu_memory_fabric_id: String,

    /// Update compute GPU memory fabric details.
    pub update_compute_gpu_memory_fabric_details: UpdateComputeGpuMemoryFabricDetails,
...
impl UpdateComputeGpuMemoryFabricRequest {
    /// Create a new UpdateComputeGpuMemoryFabricRequest with required fields
    pub fn new(required: UpdateComputeGpuMemoryFabricRequestRequired) -> Self {
        Self {
