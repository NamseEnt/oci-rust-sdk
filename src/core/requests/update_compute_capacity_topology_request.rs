...
pub struct UpdateComputeCapacityTopologyRequest {
    ...
    pub update_compute_capacity_topology_details: UpdateComputeCapacityTopologyDetails,
...
impl UpdateComputeCapacityTopologyRequest {
    /// Create a new UpdateComputeCapacityTopologyRequest with required fields
    pub fn new(required: UpdateComputeCapacityTopologyRequestRequired) -> Self {
        Self {
