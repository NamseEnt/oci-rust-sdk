...
pub struct DeleteComputeHostGroupRequest {
...
/// Required fields for DeleteComputeHostGroupRequest
pub struct DeleteComputeHostGroupRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host group.
    pub compute_host_group_id: String,
}

impl DeleteComputeHostGroupRequest {
    /// Create a new DeleteComputeHostGroupRequest with required fields
    pub fn new(required: DeleteComputeHostGroupRequestRequired) -> Self {
        Self {
