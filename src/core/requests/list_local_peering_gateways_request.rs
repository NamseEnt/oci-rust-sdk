...
pub struct ListLocalPeeringGatewaysRequest {
...
impl ListLocalPeeringGatewaysRequest {
    /// Create a new ListLocalPeeringGatewaysRequest with required fields
    pub fn new(required: ListLocalPeeringGatewaysRequestRequired) -> Self {
        Self {
