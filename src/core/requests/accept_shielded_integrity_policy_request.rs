...
pub struct AcceptShieldedIntegrityPolicyRequest {
...
impl AcceptShieldedIntegrityPolicyRequest {
    /// Create a new AcceptShieldedIntegrityPolicyRequest with required fields
    pub fn new(required: AcceptShieldedIntegrityPolicyRequestRequired) -> Self {
        Self {
