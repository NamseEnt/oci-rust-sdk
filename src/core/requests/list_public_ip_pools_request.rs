...
pub struct ListPublicIpPoolsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListPublicIpPoolsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListPublicIpPoolsRequestSortOrder>,
}

/// Required fields for ListPublicIpPoolsRequest
pub struct ListPublicIpPoolsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListPublicIpPoolsRequest {
    /// Create a new ListPublicIpPoolsRequest with required fields
    pub fn new(required: ListPublicIpPoolsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListPublicIpPoolsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListPublicIpPoolsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListPublicIpPoolsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListPublicIpPoolsRequestSortOrder) -> Self {
