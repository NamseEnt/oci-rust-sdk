...
pub struct GetBootVolumeKmsKeyRequest {
...
impl GetBootVolumeKmsKeyRequest {
    /// Create a new GetBootVolumeKmsKeyRequest with required fields
    pub fn new(required: GetBootVolumeKmsKeyRequestRequired) -> Self {
        Self {
