...
pub struct ChangeComputeClusterCompartmentRequest {
    ...
    pub change_compute_cluster_compartment_details: ChangeComputeClusterCompartmentDetails,
...
impl ChangeComputeClusterCompartmentRequest {
    /// Create a new ChangeComputeClusterCompartmentRequest with required fields
    pub fn new(required: ChangeComputeClusterCompartmentRequestRequired) -> Self {
        Self {
