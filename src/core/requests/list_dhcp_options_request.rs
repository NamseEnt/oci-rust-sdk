...
pub struct ListDhcpOptionsRequest {
...
/// Required fields for ListDhcpOptionsRequest
pub struct ListDhcpOptionsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListDhcpOptionsRequest {
    /// Create a new ListDhcpOptionsRequest with required fields
    pub fn new(required: ListDhcpOptionsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListDhcpOptionsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListDhcpOptionsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListDhcpOptionsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListDhcpOptionsRequestSortOrder) -> Self {
