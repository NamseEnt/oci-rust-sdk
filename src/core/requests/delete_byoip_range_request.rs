...
pub struct DeleteByoipRangeRequest {
...
/// Required fields for DeleteByoipRangeRequest
pub struct DeleteByoipRangeRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the {@code ByoipRange} resource containing the BYOIP CIDR block.
    pub byoip_range_id: String,
}

impl DeleteByoipRangeRequest {
    /// Create a new DeleteByoipRangeRequest with required fields
    pub fn new(required: DeleteByoipRangeRequestRequired) -> Self {
        Self {
