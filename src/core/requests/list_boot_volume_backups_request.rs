...
pub struct ListBootVolumeBackupsRequest {
...
/// Required fields for ListBootVolumeBackupsRequest
pub struct ListBootVolumeBackupsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListBootVolumeBackupsRequest {
    /// Create a new ListBootVolumeBackupsRequest with required fields
    pub fn new(required: ListBootVolumeBackupsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListBootVolumeBackupsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListBootVolumeBackupsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListBootVolumeBackupsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListBootVolumeBackupsRequestSortOrder) -> Self {
