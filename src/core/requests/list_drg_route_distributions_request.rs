...
pub struct ListDrgRouteDistributionsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListDrgRouteDistributionsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListDrgRouteDistributionsRequestSortOrder>,
...
/// Required fields for ListDrgRouteDistributionsRequest
pub struct ListDrgRouteDistributionsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG.
    pub drg_id: String,
}

impl ListDrgRouteDistributionsRequest {
    /// Create a new ListDrgRouteDistributionsRequest with required fields
    pub fn new(required: ListDrgRouteDistributionsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListDrgRouteDistributionsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListDrgRouteDistributionsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListDrgRouteDistributionsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListDrgRouteDistributionsRequestSortOrder) -> Self {
