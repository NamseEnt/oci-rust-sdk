...
pub struct ListByoasnsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListByoasnsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListByoasnsRequestSortOrder>,
}


/// Required fields for ListByoasnsRequest
pub struct ListByoasnsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListByoasnsRequest {
    /// Create a new ListByoasnsRequest with required fields
    pub fn new(required: ListByoasnsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListByoasnsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListByoasnsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListByoasnsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListByoasnsRequestSortOrder) -> Self {
