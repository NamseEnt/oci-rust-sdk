...
pub struct CreateComputeGpuMemoryClusterRequest {
    /// The configuration details of a GPU memory cluster
    pub create_compute_gpu_memory_cluster_details: CreateComputeGpuMemoryClusterDetails,
...
impl CreateComputeGpuMemoryClusterRequest {
