...
pub struct ValidateByoipRangeRequest {
...
/// Required fields for ValidateByoipRangeRequest
pub struct ValidateByoipRangeRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the {@code ByoipRange} resource containing the BYOIP CIDR block.
    pub byoip_range_id: String,
}

impl ValidateByoipRangeRequest {
    /// Create a new ValidateByoipRangeRequest with required fields
    pub fn new(required: ValidateByoipRangeRequestRequired) -> Self {
        Self {
