...
pub struct ListInstancePoolsRequest {
...
/// Required fields for ListInstancePoolsRequest
pub struct ListInstancePoolsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListInstancePoolsRequest {
    /// Create a new ListInstancePoolsRequest with required fields
    pub fn new(required: ListInstancePoolsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListInstancePoolsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListInstancePoolsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListInstancePoolsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListInstancePoolsRequestSortOrder) -> Self {
