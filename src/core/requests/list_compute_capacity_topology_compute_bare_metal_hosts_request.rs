...
pub struct ListComputeCapacityTopologyComputeBareMetalHostsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeCapacityTopologyComputeBareMetalHostsRequestSortBy>,
...
impl ListComputeCapacityTopologyComputeBareMetalHostsRequest {
    /// Create a new ListComputeCapacityTopologyComputeBareMetalHostsRequest with required fields
    pub fn new(required: ListComputeCapacityTopologyComputeBareMetalHostsRequestRequired) -> Self {
        Self {
