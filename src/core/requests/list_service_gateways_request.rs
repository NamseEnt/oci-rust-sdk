...
pub struct ListServiceGatewaysRequest {
...
/// Required fields for ListServiceGatewaysRequest
pub struct ListServiceGatewaysRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListServiceGatewaysRequest {
    /// Create a new ListServiceGatewaysRequest with required fields
    pub fn new(required: ListServiceGatewaysRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListServiceGatewaysRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListServiceGatewaysRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListServiceGatewaysRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListServiceGatewaysRequestSortOrder) -> Self {
