...
pub struct ChangeVirtualCircuitCompartmentRequest {
    ...
    pub change_virtual_circuit_compartment_details: ChangeVirtualCircuitCompartmentDetails,
...
impl ChangeVirtualCircuitCompartmentRequest {
    /// Create a new ChangeVirtualCircuitCompartmentRequest with required fields
    pub fn new(required: ChangeVirtualCircuitCompartmentRequestRequired) -> Self {
        Self {
