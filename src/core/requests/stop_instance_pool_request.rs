...
pub struct StopInstancePoolRequest {
...
/// Required fields for StopInstancePoolRequest
pub struct StopInstancePoolRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
    pub instance_pool_id: String,
}

impl StopInstancePoolRequest {
    /// Create a new StopInstancePoolRequest with required fields
    pub fn new(required: StopInstancePoolRequestRequired) -> Self {
        Self {
