...
/// Required fields for DeleteRouteTableRequest
pub struct DeleteRouteTableRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route table.
    pub rt_id: String,
}

impl DeleteRouteTableRequest {
    /// Create a new DeleteRouteTableRequest with required fields
    pub fn new(required: DeleteRouteTableRequestRequired) -> Self {
        Self {
