...
pub struct Ipv6VnicDetachRequest {
...
impl Ipv6VnicDetachRequest {
    /// Create a new Ipv6VnicDetachRequest with required fields
    pub fn new(required: Ipv6VnicDetachRequestRequired) -> Self {
        Self {
