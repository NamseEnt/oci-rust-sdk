...
pub struct ListClusterNetworkInstancesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListClusterNetworkInstancesRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListClusterNetworkInstancesRequestSortOrder>,
}


/// Required fields for ListClusterNetworkInstancesRequest
pub struct ListClusterNetworkInstancesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
...
impl ListClusterNetworkInstancesRequest {
    /// Create a new ListClusterNetworkInstancesRequest with required fields
    pub fn new(required: ListClusterNetworkInstancesRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListClusterNetworkInstancesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListClusterNetworkInstancesRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListClusterNetworkInstancesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListClusterNetworkInstancesRequestSortOrder) -> Self {
