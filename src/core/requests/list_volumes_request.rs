...
impl ListVolumesRequest {
    /// Create a new ListVolumesRequest
    pub fn new() -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListVolumesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListVolumesRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListVolumesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListVolumesRequestSortOrder) -> Self {
...
impl Default for ListVolumesRequest {
    fn default() -> Self {
        Self::new()
    }
}
