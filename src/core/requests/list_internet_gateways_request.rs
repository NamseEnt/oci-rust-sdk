...
pub struct ListInternetGatewaysRequest {
...
/// Required fields for ListInternetGatewaysRequest
pub struct ListInternetGatewaysRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListInternetGatewaysRequest {
    /// Create a new ListInternetGatewaysRequest with required fields
    pub fn new(required: ListInternetGatewaysRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListInternetGatewaysRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListInternetGatewaysRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListInternetGatewaysRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListInternetGatewaysRequestSortOrder) -> Self {
