...
pub struct SoftresetInstancePoolRequest {
...
impl SoftresetInstancePoolRequest {
    /// Create a new SoftresetInstancePoolRequest with required fields
    pub fn new(required: SoftresetInstancePoolRequestRequired) -> Self {
        Self {
