...
pub struct DeleteNetworkSecurityGroupRequest {
...
/// Required fields for DeleteNetworkSecurityGroupRequest
pub struct DeleteNetworkSecurityGroupRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security group.
    pub network_security_group_id: String,
}

impl DeleteNetworkSecurityGroupRequest {
    /// Create a new DeleteNetworkSecurityGroupRequest with required fields
    pub fn new(required: DeleteNetworkSecurityGroupRequestRequired) -> Self {
        Self {
