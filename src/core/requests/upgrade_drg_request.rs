...
impl UpgradeDrgRequest {
    /// Create a new UpgradeDrgRequest with required fields
    pub fn new(required: UpgradeDrgRequestRequired) -> Self {
        Self {
