...
pub struct DeleteDrgRouteDistributionRequest {
...
impl DeleteDrgRouteDistributionRequest {
    /// Create a new DeleteDrgRouteDistributionRequest with required fields
    pub fn new(required: DeleteDrgRouteDistributionRequestRequired) -> Self {
        Self {
