...
pub struct ChangeLocalPeeringGatewayCompartmentRequest {
...
impl ChangeLocalPeeringGatewayCompartmentRequest {
    /// Create a new ChangeLocalPeeringGatewayCompartmentRequest with required fields
    pub fn new(required: ChangeLocalPeeringGatewayCompartmentRequestRequired) -> Self {
        Self {
