...
pub struct PrivateIpVnicDetachRequest {
...
impl PrivateIpVnicDetachRequest {
    /// Create a new PrivateIpVnicDetachRequest with required fields
    pub fn new(required: PrivateIpVnicDetachRequestRequired) -> Self {
        Self {
