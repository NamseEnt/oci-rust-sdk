...
pub struct ListVolumeGroupsRequest {
...
/// Required fields for ListVolumeGroupsRequest
pub struct ListVolumeGroupsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListVolumeGroupsRequest {
    /// Create a new ListVolumeGroupsRequest with required fields
    pub fn new(required: ListVolumeGroupsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListVolumeGroupsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListVolumeGroupsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListVolumeGroupsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListVolumeGroupsRequestSortOrder) -> Self {
