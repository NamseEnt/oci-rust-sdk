...
pub struct DeleteBootVolumeBackupRequest {
...
impl DeleteBootVolumeBackupRequest {
    /// Create a new DeleteBootVolumeBackupRequest with required fields
    pub fn new(required: DeleteBootVolumeBackupRequestRequired) -> Self {
        Self {
