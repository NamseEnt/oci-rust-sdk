...
impl ListVcnsRequest {
    /// Create a new ListVcnsRequest with required fields
    pub fn new(required: ListVcnsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListVcnsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListVcnsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListVcnsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListVcnsRequestSortOrder) -> Self {
