...
pub struct ListConsoleHistoriesRequest {
...
/// Required fields for ListConsoleHistoriesRequest
pub struct ListConsoleHistoriesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListConsoleHistoriesRequest {
    /// Create a new ListConsoleHistoriesRequest with required fields
    pub fn new(required: ListConsoleHistoriesRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListConsoleHistoriesRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListConsoleHistoriesRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListConsoleHistoriesRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListConsoleHistoriesRequestSortOrder) -> Self {
