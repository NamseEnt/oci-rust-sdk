...
/// Required fields for CreateVtapRequest
pub struct CreateVtapRequestRequired {
    /// Details used to create a VTAP.
    pub create_vtap_details: CreateVtapDetails,
}
...
impl CreateVtapRequest {
    ...
    pub fn new(required: CreateVtapRequestRequired) -> Self {
        Self {
            create_vtap_details: required.create_vtap_details,
    ...
    pub fn set_create_vtap_details(mut self, value: CreateVtapDetails) -> Self {
        self.create_vtap_details = value;
        self
    }
