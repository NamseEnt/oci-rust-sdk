...
pub struct ChangeRouteTableCompartmentRequest {
    ...
    pub change_route_table_compartment_details: ChangeRouteTableCompartmentDetails,
...
impl ChangeRouteTableCompartmentRequest {
    /// Create a new ChangeRouteTableCompartmentRequest with required fields
    pub fn new(required: ChangeRouteTableCompartmentRequestRequired) -> Self {
        Self {
            rt_id: required.rt_id,

            change_route_table_compartment_details: required.change_route_table_compartment_details,
