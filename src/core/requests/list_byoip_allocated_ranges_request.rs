...
pub struct ListByoipAllocatedRangesRequest {
...
impl ListByoipAllocatedRangesRequest {
    /// Create a new ListByoipAllocatedRangesRequest with required fields
    pub fn new(required: ListByoipAllocatedRangesRequestRequired) -> Self {
        Self {
