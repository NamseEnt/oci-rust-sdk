...
pub struct ListSecurityListsRequest {
...
/// Required fields for ListSecurityListsRequest
pub struct ListSecurityListsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListSecurityListsRequest {
    /// Create a new ListSecurityListsRequest with required fields
    pub fn new(required: ListSecurityListsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListSecurityListsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListSecurityListsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListSecurityListsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListSecurityListsRequestSortOrder) -> Self {
