...
pub struct CreateRemotePeeringConnectionRequest {
    /// Request to create peering connection to remote region
    pub create_remote_peering_connection_details: CreateRemotePeeringConnectionDetails,
...
impl CreateRemotePeeringConnectionRequest {
