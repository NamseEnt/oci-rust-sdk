...
pub struct ListComputeClustersRequest {
...
/// Required fields for ListComputeClustersRequest
pub struct ListComputeClustersRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListComputeClustersRequest {
    /// Create a new ListComputeClustersRequest with required fields
    pub fn new(required: ListComputeClustersRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListComputeClustersRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListComputeClustersRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListComputeClustersRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListComputeClustersRequestSortOrder) -> Self {
