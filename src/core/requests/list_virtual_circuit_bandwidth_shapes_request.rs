...
pub struct ListVirtualCircuitBandwidthShapesRequest {
...
/// Required fields for ListVirtualCircuitBandwidthShapesRequest
pub struct ListVirtualCircuitBandwidthShapesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListVirtualCircuitBandwidthShapesRequest {
    /// Create a new ListVirtualCircuitBandwidthShapesRequest with required fields
    pub fn new(required: ListVirtualCircuitBandwidthShapesRequestRequired) -> Self {
        Self {
