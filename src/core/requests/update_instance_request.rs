...
/// Required fields for UpdateInstanceRequest
pub struct UpdateInstanceRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
    pub instance_id: String,
...
impl UpdateInstanceRequest {
    ...
    pub fn new(required: UpdateInstanceRequestRequired) -> Self {
        Self {
            ...
            update_instance_details: required.update_instance_details,
    ...
    pub fn set_update_instance_details(mut self, value: UpdateInstanceDetails) -> Self {
        self.update_instance_details = value;
        self
    }
