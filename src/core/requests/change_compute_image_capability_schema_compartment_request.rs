...
pub struct ChangeComputeImageCapabilitySchemaCompartmentRequest {
...
impl ChangeComputeImageCapabilitySchemaCompartmentRequest {
    /// Create a new ChangeComputeImageCapabilitySchemaCompartmentRequest with required fields
    pub fn new(required: ChangeComputeImageCapabilitySchemaCompartmentRequestRequired) -> Self {
        Self {
