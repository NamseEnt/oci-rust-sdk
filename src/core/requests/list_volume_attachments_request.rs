...
pub struct ListVolumeAttachmentsRequest {
...
impl ListVolumeAttachmentsRequest {
    /// Create a new ListVolumeAttachmentsRequest with required fields
    pub fn new(required: ListVolumeAttachmentsRequestRequired) -> Self {
        Self {
