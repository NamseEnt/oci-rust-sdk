...
pub struct GetVcnDnsResolverAssociationRequest {
...
impl GetVcnDnsResolverAssociationRequest {
    /// Create a new GetVcnDnsResolverAssociationRequest with required fields
    pub fn new(required: GetVcnDnsResolverAssociationRequestRequired) -> Self {
        Self {
