...
pub struct ListInstanceConfigurationsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListInstanceConfigurationsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListInstanceConfigurationsRequestSortOrder>,
}


/// Required fields for ListInstanceConfigurationsRequest
pub struct ListInstanceConfigurationsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListInstanceConfigurationsRequest {
    /// Create a new ListInstanceConfigurationsRequest with required fields
    pub fn new(required: ListInstanceConfigurationsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListInstanceConfigurationsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListInstanceConfigurationsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListInstanceConfigurationsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListInstanceConfigurationsRequestSortOrder) -> Self {
