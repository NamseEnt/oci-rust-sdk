...
pub struct ChangeCpeCompartmentRequest {
    ...
    pub change_cpe_compartment_details: ChangeCpeCompartmentDetails,
...
impl ChangeCpeCompartmentRequest {
    /// Create a new ChangeCpeCompartmentRequest with required fields
    pub fn new(required: ChangeCpeCompartmentRequestRequired) -> Self {
        Self {
            cpe_id: required.cpe_id,

            change_cpe_compartment_details: required.change_cpe_compartment_details,
