...
impl CopyBootVolumeBackupRequest {
    /// Create a new CopyBootVolumeBackupRequest with required fields
    pub fn new(required: CopyBootVolumeBackupRequestRequired) -> Self {
        Self {
            boot_volume_backup_id: required.boot_volume_backup_id,

            copy_boot_volume_backup_details: required.copy_boot_volume_backup_details,
