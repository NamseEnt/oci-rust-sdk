...
pub struct ListImageShapeCompatibilityEntriesRequest {
...
impl ListImageShapeCompatibilityEntriesRequest {
    /// Create a new ListImageShapeCompatibilityEntriesRequest with required fields
    pub fn new(required: ListImageShapeCompatibilityEntriesRequestRequired) -> Self {
        Self {
