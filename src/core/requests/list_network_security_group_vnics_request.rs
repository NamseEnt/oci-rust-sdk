...
pub struct ListNetworkSecurityGroupVnicsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListNetworkSecurityGroupVnicsRequestSortBy>,
...
impl ListNetworkSecurityGroupVnicsRequest {
    /// Create a new ListNetworkSecurityGroupVnicsRequest with required fields
    pub fn new(required: ListNetworkSecurityGroupVnicsRequestRequired) -> Self {
        Self {
    ...
    pub fn with_sort_by(mut self, value: ListNetworkSecurityGroupVnicsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListNetworkSecurityGroupVnicsRequestSortOrder) -> Self {
