...
pub struct RemoveIpv6VcnCidrRequest {
...
impl RemoveIpv6VcnCidrRequest {
    /// Create a new RemoveIpv6VcnCidrRequest with required fields
    pub fn new(required: RemoveIpv6VcnCidrRequestRequired) -> Self {
        Self {
    ...
    /// Set remove_vcn_ipv6_cidr_details (unwraps Option)
    pub fn with_remove_vcn_ipv6_cidr_details(mut self, value: RemoveVcnIpv6CidrDetails) -> Self {
        self.remove_vcn_ipv6_cidr_details = Some(value);
        self
    }
}
