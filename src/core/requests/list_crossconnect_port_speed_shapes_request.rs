...
pub struct ListCrossconnectPortSpeedShapesRequest {
...
/// Required fields for ListCrossconnectPortSpeedShapesRequest
pub struct ListCrossconnectPortSpeedShapesRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListCrossconnectPortSpeedShapesRequest {
    /// Create a new ListCrossconnectPortSpeedShapesRequest with required fields
    pub fn new(required: ListCrossconnectPortSpeedShapesRequestRequired) -> Self {
        Self {
