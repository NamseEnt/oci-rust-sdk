...
pub struct CreateComputeCapacityReservationRequest {
    ...
    pub create_compute_capacity_reservation_details: CreateComputeCapacityReservationDetails,
...
impl CreateComputeCapacityReservationRequest {
