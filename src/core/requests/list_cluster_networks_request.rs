...
pub struct ListClusterNetworksRequest {
...
/// Required fields for ListClusterNetworksRequest
pub struct ListClusterNetworksRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListClusterNetworksRequest {
    /// Create a new ListClusterNetworksRequest with required fields
    pub fn new(required: ListClusterNetworksRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListClusterNetworksRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListClusterNetworksRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListClusterNetworksRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListClusterNetworksRequestSortOrder) -> Self {
