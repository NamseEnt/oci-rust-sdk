...
pub struct ListVirtualCircuitsRequest {
...
/// Required fields for ListVirtualCircuitsRequest
pub struct ListVirtualCircuitsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
    pub compartment_id: String,
}

impl ListVirtualCircuitsRequest {
    /// Create a new ListVirtualCircuitsRequest with required fields
    pub fn new(required: ListVirtualCircuitsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListVirtualCircuitsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListVirtualCircuitsRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListVirtualCircuitsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListVirtualCircuitsRequestSortOrder) -> Self {
