...
impl UpdateImageRequest {
    ...
    pub fn new(required: UpdateImageRequestRequired) -> Self {
        Self {
            ...
            update_image_details: required.update_image_details,
    ...
    pub fn set_update_image_details(mut self, value: UpdateImageDetails) -> Self {
        self.update_image_details = value;
        self
    }
