...
pub struct AttachComputeHostGroupHostRequest {
    ...
    pub attach_compute_host_group_host_details: AttachComputeHostGroupHostDetails,
...
impl AttachComputeHostGroupHostRequest {
    /// Create a new AttachComputeHostGroupHostRequest with required fields
    pub fn new(required: AttachComputeHostGroupHostRequestRequired) -> Self {
        Self {
            compute_host_id: required.compute_host_id,

            attach_compute_host_group_host_details: required.attach_compute_host_group_host_details,
