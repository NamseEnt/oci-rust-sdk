...
pub struct ChangeComputeGpuMemoryClusterCompartmentRequest {
...
impl ChangeComputeGpuMemoryClusterCompartmentRequest {
    /// Create a new ChangeComputeGpuMemoryClusterCompartmentRequest with required fields
    pub fn new(required: ChangeComputeGpuMemoryClusterCompartmentRequestRequired) -> Self {
        Self {
