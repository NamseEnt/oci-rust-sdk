...
pub struct ListCpeDeviceShapesRequest {
...
impl ListCpeDeviceShapesRequest {
    /// Create a new ListCpeDeviceShapesRequest
    pub fn new() -> Self {
        Self {
            limit: None,
...
impl Default for ListCpeDeviceShapesRequest {
    fn default() -> Self {
        Self::new()
    }
}
