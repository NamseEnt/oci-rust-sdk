...
pub struct UpdateComputeClusterRequest {
    ...
    pub update_compute_cluster_details: UpdateComputeClusterDetails,
...
impl UpdateComputeClusterRequest {
    /// Create a new UpdateComputeClusterRequest with required fields
    pub fn new(required: UpdateComputeClusterRequestRequired) -> Self {
        Self {
            compute_cluster_id: required.compute_cluster_id,

            update_compute_cluster_details: required.update_compute_cluster_details,
