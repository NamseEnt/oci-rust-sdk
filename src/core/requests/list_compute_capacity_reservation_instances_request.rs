...
pub struct ListComputeCapacityReservationInstancesRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeCapacityReservationInstancesRequestSortBy>,
...
impl ListComputeCapacityReservationInstancesRequest {
    /// Create a new ListComputeCapacityReservationInstancesRequest with required fields
    pub fn new(required: ListComputeCapacityReservationInstancesRequestRequired) -> Self {
        Self {
