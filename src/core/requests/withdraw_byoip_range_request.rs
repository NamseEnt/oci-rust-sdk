...
pub struct WithdrawByoipRangeRequest {
...
/// Required fields for WithdrawByoipRangeRequest
pub struct WithdrawByoipRangeRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the {@code ByoipRange} resource containing the BYOIP CIDR block.
    pub byoip_range_id: String,
}

impl WithdrawByoipRangeRequest {
    /// Create a new WithdrawByoipRangeRequest with required fields
    pub fn new(required: WithdrawByoipRangeRequestRequired) -> Self {
        Self {
