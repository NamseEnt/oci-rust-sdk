...
pub struct DeleteComputeImageCapabilitySchemaRequest {
...
impl DeleteComputeImageCapabilitySchemaRequest {
    /// Create a new DeleteComputeImageCapabilitySchemaRequest with required fields
    pub fn new(required: DeleteComputeImageCapabilitySchemaRequestRequired) -> Self {
        Self {
