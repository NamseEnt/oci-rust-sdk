...
pub struct GetVcnTopologyRequest {
    ...
    pub access_level: Option<GetVcnTopologyRequestAccessLevel>,
...
impl GetVcnTopologyRequest {
    /// Create a new GetVcnTopologyRequest with required fields
    pub fn new(required: GetVcnTopologyRequestRequired) -> Self {
        Self {
    ...
    /// Set access_level
    pub fn set_access_level(mut self, value: Option<GetVcnTopologyRequestAccessLevel>) -> Self {
    ...
    pub fn with_access_level(mut self, value: GetVcnTopologyRequestAccessLevel) -> Self {
