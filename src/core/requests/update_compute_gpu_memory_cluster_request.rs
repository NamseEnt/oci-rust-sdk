...
pub struct UpdateComputeGpuMemoryClusterRequest {
    ...
    pub update_compute_gpu_memory_cluster_details: UpdateComputeGpuMemoryClusterDetails,
...
impl UpdateComputeGpuMemoryClusterRequest {
    /// Create a new UpdateComputeGpuMemoryClusterRequest with required fields
    pub fn new(required: UpdateComputeGpuMemoryClusterRequestRequired) -> Self {
        Self {
