...
pub struct TerminationProceedInstancePoolInstanceRequest {
...
impl TerminationProceedInstancePoolInstanceRequest {
    /// Create a new TerminationProceedInstancePoolInstanceRequest with required fields
    pub fn new(required: TerminationProceedInstancePoolInstanceRequestRequired) -> Self {
        Self {
