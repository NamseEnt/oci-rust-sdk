...
pub struct ListVirtualCircuitAssociatedTunnelsRequest {
...
/// Required fields for ListVirtualCircuitAssociatedTunnelsRequest
pub struct ListVirtualCircuitAssociatedTunnelsRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the virtual circuit.
    pub virtual_circuit_id: String,
}

impl ListVirtualCircuitAssociatedTunnelsRequest {
    /// Create a new ListVirtualCircuitAssociatedTunnelsRequest with required fields
    pub fn new(required: ListVirtualCircuitAssociatedTunnelsRequestRequired) -> Self {
        Self {
