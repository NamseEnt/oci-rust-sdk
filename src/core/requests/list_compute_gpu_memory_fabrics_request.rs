...
pub struct ListComputeGpuMemoryFabricsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub compute_gpu_memory_fabric_id: Option<String>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub compute_gpu_memory_fabric_lifecycle_state: Option<String>,

    /// A filter to return ComputeGpuMemoryFabricSummary resources that match the given fabric health.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub compute_gpu_memory_fabric_health: Option<String>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListComputeGpuMemoryFabricsRequestSortBy>,
...
impl ListComputeGpuMemoryFabricsRequest {
    /// Create a new ListComputeGpuMemoryFabricsRequest with required fields
    pub fn new(required: ListComputeGpuMemoryFabricsRequestRequired) -> Self {
        Self {
            compartment_id: required.compartment_id,

            opc_request_id: None,

            compute_gpu_memory_fabric_id: None,
            ...
            compute_gpu_memory_fabric_lifecycle_state: None,

            compute_gpu_memory_fabric_health: None,
    ...
    pub fn set_compute_gpu_memory_fabric_id(mut self, value: Option<String>) -> Self {
    ...
    /// Set compute_gpu_memory_fabric_lifecycle_state
    pub fn set_compute_gpu_memory_fabric_lifecycle_state(mut self, value: Option<String>) -> Self {
        self.compute_gpu_memory_fabric_lifecycle_state = value;
        self
    }

    /// Set compute_gpu_memory_fabric_health
    pub fn set_compute_gpu_memory_fabric_health(mut self, value: Option<String>) -> Self {
        self.compute_gpu_memory_fabric_health = value;
        self
    }
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListComputeGpuMemoryFabricsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }
    ...
    /// Set compute_gpu_memory_fabric_id (unwraps Option)
    pub fn with_compute_gpu_memory_fabric_id(mut self, value: impl Into<String>) -> Self {
        self.compute_gpu_memory_fabric_id = Some(value.into());
        self
    }
    ...
    /// Set compute_gpu_memory_fabric_health (unwraps Option)
    pub fn with_compute_gpu_memory_fabric_health(mut self, value: impl Into<String>) -> Self {
        self.compute_gpu_memory_fabric_health = Some(value.into());
        self
    }
    ...
    pub fn with_sort_by(mut self, value: ListComputeGpuMemoryFabricsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListComputeGpuMemoryFabricsRequestSortOrder) -> Self {
