...
pub struct DeleteCrossConnectGroupRequest {
...
/// Required fields for DeleteCrossConnectGroupRequest
pub struct DeleteCrossConnectGroupRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cross-connect group.
    pub cross_connect_group_id: String,
}

impl DeleteCrossConnectGroupRequest {
    /// Create a new DeleteCrossConnectGroupRequest with required fields
    pub fn new(required: DeleteCrossConnectGroupRequestRequired) -> Self {
        Self {
