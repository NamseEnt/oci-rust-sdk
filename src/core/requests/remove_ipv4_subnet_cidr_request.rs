...
pub struct RemoveIpv4SubnetCidrRequest {
    ...
    pub remove_ipv4_subnet_cidr_details: RemoveIpv4SubnetCidrDetails,
...
impl RemoveIpv4SubnetCidrRequest {
    /// Create a new RemoveIpv4SubnetCidrRequest with required fields
    pub fn new(required: RemoveIpv4SubnetCidrRequestRequired) -> Self {
        Self {
            subnet_id: required.subnet_id,

            remove_ipv4_subnet_cidr_details: required.remove_ipv4_subnet_cidr_details,
