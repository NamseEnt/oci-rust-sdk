...
pub struct LaunchInstanceRequestRequired {
    /// Instance details
    pub launch_instance_details: LaunchInstanceDetails,
}
...
impl LaunchInstanceRequest {
    ...
    pub fn set_launch_instance_details(mut self, value: LaunchInstanceDetails) -> Self {
        self.launch_instance_details = value;
        self
    }
