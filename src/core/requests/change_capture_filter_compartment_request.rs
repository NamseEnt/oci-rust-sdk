...
impl ChangeCaptureFilterCompartmentRequest {
    ...
    pub fn new(required: ChangeCaptureFilterCompartmentRequestRequired) -> Self {
        Self {
            ...
            change_capture_filter_compartment_details: required.change_capture_filter_compartment_details,
    ...
    pub fn set_change_capture_filter_compartment_details(mut self, value: ChangeCaptureFilterCompartmentDetails) -> Self {
