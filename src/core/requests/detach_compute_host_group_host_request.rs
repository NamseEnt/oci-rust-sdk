...
pub struct DetachComputeHostGroupHostRequest {
    ...
    pub detach_compute_host_group_host_details: DetachComputeHostGroupHostDetails,
...
impl DetachComputeHostGroupHostRequest {
    /// Create a new DetachComputeHostGroupHostRequest with required fields
    pub fn new(required: DetachComputeHostGroupHostRequestRequired) -> Self {
        Self {
            compute_host_id: required.compute_host_id,

            detach_compute_host_group_host_details: required.detach_compute_host_group_host_details,
