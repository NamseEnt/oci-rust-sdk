...
pub struct ResetInstancePoolRequest {
...
/// Required fields for ResetInstancePoolRequest
pub struct ResetInstancePoolRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
    pub instance_pool_id: String,
}

impl ResetInstancePoolRequest {
    /// Create a new ResetInstancePoolRequest with required fields
    pub fn new(required: ResetInstancePoolRequestRequired) -> Self {
        Self {
