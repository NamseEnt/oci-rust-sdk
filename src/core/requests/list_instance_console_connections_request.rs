...
pub struct ListInstanceConsoleConnectionsRequest {
...
impl ListInstanceConsoleConnectionsRequest {
    /// Create a new ListInstanceConsoleConnectionsRequest with required fields
    pub fn new(required: ListInstanceConsoleConnectionsRequestRequired) -> Self {
        Self {
