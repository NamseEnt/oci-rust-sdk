...
pub struct ChangeComputeHostCompartmentRequest {
    ...
    pub change_compute_host_compartment_details: ChangeComputeHostCompartmentDetails,
...
impl ChangeComputeHostCompartmentRequest {
    /// Create a new ChangeComputeHostCompartmentRequest with required fields
    pub fn new(required: ChangeComputeHostCompartmentRequestRequired) -> Self {
        Self {
