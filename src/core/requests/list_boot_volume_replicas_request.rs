...
pub struct ListBootVolumeReplicasRequest {
...
impl ListBootVolumeReplicasRequest {
    /// Create a new ListBootVolumeReplicasRequest
    pub fn new() -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListBootVolumeReplicasRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }

    /// Set sort_order
    pub fn set_sort_order(mut self, value: Option<ListBootVolumeReplicasRequestSortOrder>) -> Self {
    ...
    pub fn with_sort_by(mut self, value: ListBootVolumeReplicasRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListBootVolumeReplicasRequestSortOrder) -> Self {
...
impl Default for ListBootVolumeReplicasRequest {
    fn default() -> Self {
        Self::new()
    }
}
