...
pub struct ListAppCatalogSubscriptionsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListAppCatalogSubscriptionsRequestSortBy>,

    /// The sort order to use, either ascending ({@code ASC}) or descending ({@code DESC}). The DISPLAYNAME sort order is case sensitive.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_order: Option<ListAppCatalogSubscriptionsRequestSortOrder>,
...
impl ListAppCatalogSubscriptionsRequest {
    /// Create a new ListAppCatalogSubscriptionsRequest with required fields
    pub fn new(required: ListAppCatalogSubscriptionsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListAppCatalogSubscriptionsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }
    ...
    pub fn with_sort_by(mut self, value: ListAppCatalogSubscriptionsRequestSortBy) -> Self {
        self.sort_by = Some(value);
        self
    }

    /// Set sort_order (unwraps Option)
    pub fn with_sort_order(mut self, value: ListAppCatalogSubscriptionsRequestSortOrder) -> Self {
