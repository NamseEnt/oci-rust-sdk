...
pub struct ChangeInstanceCompartmentRequest {
    ...
    pub change_instance_compartment_details: ChangeInstanceCompartmentDetails,
...
impl ChangeInstanceCompartmentRequest {
    /// Create a new ChangeInstanceCompartmentRequest with required fields
    pub fn new(required: ChangeInstanceCompartmentRequestRequired) -> Self {
        Self {
            instance_id: required.instance_id,

            change_instance_compartment_details: required.change_instance_compartment_details,
