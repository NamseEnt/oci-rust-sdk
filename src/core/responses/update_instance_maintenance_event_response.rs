...
pub struct UpdateInstanceMaintenanceEventResponse {
...
/// Required fields for UpdateInstanceMaintenanceEventResponse
pub struct UpdateInstanceMaintenanceEventResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl UpdateInstanceMaintenanceEventResponse {
    /// Create a new UpdateInstanceMaintenanceEventResponse with required fields
    pub fn new(required: UpdateInstanceMaintenanceEventResponseRequired) -> Self {
        Self {
