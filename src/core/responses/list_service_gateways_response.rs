...
pub struct ListServiceGatewaysResponse {
    ...
    pub items: Vec<ServiceGateway>,
}

/// Required fields for ListServiceGatewaysResponse
pub struct ListServiceGatewaysResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListServiceGatewaysResponse {
    /// Create a new ListServiceGatewaysResponse with required fields
    pub fn new(required: ListServiceGatewaysResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<ServiceGateway>) -> Self {
        self.items = value;
        self
    }
}
