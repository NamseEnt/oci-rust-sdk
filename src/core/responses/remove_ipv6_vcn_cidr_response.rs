...
pub struct RemoveIpv6VcnCidrResponse {
...
/// Required fields for RemoveIpv6VcnCidrResponse
pub struct RemoveIpv6VcnCidrResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl RemoveIpv6VcnCidrResponse {
    /// Create a new RemoveIpv6VcnCidrResponse with required fields
    pub fn new(required: RemoveIpv6VcnCidrResponseRequired) -> Self {
        Self {
            etag: required.etag,
