...
pub struct ChangeCaptureFilterCompartmentResponse {
...
/// Required fields for ChangeCaptureFilterCompartmentResponse
pub struct ChangeCaptureFilterCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeCaptureFilterCompartmentResponse {
    /// Create a new ChangeCaptureFilterCompartmentResponse with required fields
    pub fn new(required: ChangeCaptureFilterCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
