...
pub struct SetOriginAsnResponse {
...
impl SetOriginAsnResponse {
    /// Create a new SetOriginAsnResponse with required fields
    pub fn new(required: SetOriginAsnResponseRequired) -> Self {
        Self {
