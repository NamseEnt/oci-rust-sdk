...
pub struct ModifyVcnCidrResponse {
...
/// Required fields for ModifyVcnCidrResponse
pub struct ModifyVcnCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ModifyVcnCidrResponse {
    /// Create a new ModifyVcnCidrResponse with required fields
    pub fn new(required: ModifyVcnCidrResponseRequired) -> Self {
        Self {
