...
pub struct ListCrossConnectsResponse {
    ...
    pub items: Vec<CrossConnect>,
}

/// Required fields for ListCrossConnectsResponse
pub struct ListCrossConnectsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListCrossConnectsResponse {
    /// Create a new ListCrossConnectsResponse with required fields
    pub fn new(required: ListCrossConnectsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<CrossConnect>) -> Self {
        self.items = value;
        self
    }
}
