...
pub struct ListComputeGlobalImageCapabilitySchemaVersionsResponse {
...
impl ListComputeGlobalImageCapabilitySchemaVersionsResponse {
    /// Create a new ListComputeGlobalImageCapabilitySchemaVersionsResponse with required fields
    pub fn new(required: ListComputeGlobalImageCapabilitySchemaVersionsResponseRequired) -> Self {
        Self {
