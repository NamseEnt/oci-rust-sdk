...
/// Required fields for AddVcnCidrResponse
pub struct AddVcnCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl AddVcnCidrResponse {
    /// Create a new AddVcnCidrResponse with required fields
    pub fn new(required: AddVcnCidrResponseRequired) -> Self {
        Self {
