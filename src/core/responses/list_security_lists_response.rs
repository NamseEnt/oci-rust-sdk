...
pub struct ListSecurityListsResponse {
    ...
    pub items: Vec<SecurityList>,
}


/// Required fields for ListSecurityListsResponse
pub struct ListSecurityListsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListSecurityListsResponse {
    /// Create a new ListSecurityListsResponse with required fields
    pub fn new(required: ListSecurityListsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<SecurityList>) -> Self {
        self.items = value;
        self
    }
}
