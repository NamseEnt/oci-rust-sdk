...
pub struct AddIpv6VcnCidrResponse {
...
/// Required fields for AddIpv6VcnCidrResponse
pub struct AddIpv6VcnCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl AddIpv6VcnCidrResponse {
    /// Create a new AddIpv6VcnCidrResponse with required fields
    pub fn new(required: AddIpv6VcnCidrResponseRequired) -> Self {
        Self {
