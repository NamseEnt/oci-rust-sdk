...
pub struct DetachInstancePoolInstanceResponse {
...
/// Required fields for DetachInstancePoolInstanceResponse
pub struct DetachInstancePoolInstanceResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DetachInstancePoolInstanceResponse {
    /// Create a new DetachInstancePoolInstanceResponse with required fields
    pub fn new(required: DetachInstancePoolInstanceResponseRequired) -> Self {
        Self {
