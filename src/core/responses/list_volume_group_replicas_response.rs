...
pub struct ListVolumeGroupReplicasResponse {
...
impl ListVolumeGroupReplicasResponse {
    /// Create a new ListVolumeGroupReplicasResponse with required fields
    pub fn new(required: ListVolumeGroupReplicasResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VolumeGroupReplica>) -> Self {
        self.items = value;
        self
    }
}
