...
/// Required fields for ExportImageResponse
pub struct ExportImageResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ExportImageResponse {
    /// Create a new ExportImageResponse with required fields
    pub fn new(required: ExportImageResponseRequired) -> Self {
        Self {
            etag: required.etag,
