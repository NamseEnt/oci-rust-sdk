...
pub struct CreateClusterNetworkResponse {
...
impl CreateClusterNetworkResponse {
    /// Create a new CreateClusterNetworkResponse with required fields
    pub fn new(required: CreateClusterNetworkResponseRequired) -> Self {
        Self {
            etag: required.etag,
