...
pub struct ValidateByoipRangeResponse {
...
impl ValidateByoipRangeResponse {
    /// Create a new ValidateByoipRangeResponse with required fields
    pub fn new(required: ValidateByoipRangeResponseRequired) -> Self {
        Self {
