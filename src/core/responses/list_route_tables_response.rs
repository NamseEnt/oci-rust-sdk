...
/// Required fields for ListRouteTablesResponse
pub struct ListRouteTablesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListRouteTablesResponse {
    /// Create a new ListRouteTablesResponse with required fields
    pub fn new(required: ListRouteTablesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<RouteTable>) -> Self {
        self.items = value;
        self
    }
}
