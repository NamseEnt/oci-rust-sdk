...
pub struct AttachBootVolumeResponse {
...
/// Required fields for AttachBootVolumeResponse
pub struct AttachBootVolumeResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl AttachBootVolumeResponse {
    /// Create a new AttachBootVolumeResponse with required fields
    pub fn new(required: AttachBootVolumeResponseRequired) -> Self {
        Self {
            etag: required.etag,
