...
pub struct UpdateComputeHostResponse {
...
/// Required fields for UpdateComputeHostResponse
pub struct UpdateComputeHostResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl UpdateComputeHostResponse {
    /// Create a new UpdateComputeHostResponse with required fields
    pub fn new(required: UpdateComputeHostResponseRequired) -> Self {
        Self {
            etag: required.etag,
