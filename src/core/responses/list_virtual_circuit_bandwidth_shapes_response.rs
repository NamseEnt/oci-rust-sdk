...
pub struct ListVirtualCircuitBandwidthShapesResponse {
...
/// Required fields for ListVirtualCircuitBandwidthShapesResponse
pub struct ListVirtualCircuitBandwidthShapesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVirtualCircuitBandwidthShapesResponse {
    /// Create a new ListVirtualCircuitBandwidthShapesResponse with required fields
    pub fn new(required: ListVirtualCircuitBandwidthShapesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VirtualCircuitBandwidthShape>) -> Self {
        self.items = value;
        self
    }
}
