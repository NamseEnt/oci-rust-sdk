...
/// Required fields for ListVolumesResponse
pub struct ListVolumesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVolumesResponse {
    /// Create a new ListVolumesResponse with required fields
    pub fn new(required: ListVolumesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<Volume>) -> Self {
        self.items = value;
        self
    }
}
