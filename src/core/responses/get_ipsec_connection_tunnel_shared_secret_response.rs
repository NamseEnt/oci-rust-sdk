...
pub struct GetIPSecConnectionTunnelSharedSecretResponse {
...
impl GetIPSecConnectionTunnelSharedSecretResponse {
    /// Create a new GetIPSecConnectionTunnelSharedSecretResponse with required fields
    pub fn new(required: GetIPSecConnectionTunnelSharedSecretResponseRequired) -> Self {
        Self {
            etag: required.etag,
