...
pub struct UpdateComputeGpuMemoryClusterResponse {
...
impl UpdateComputeGpuMemoryClusterResponse {
    /// Create a new UpdateComputeGpuMemoryClusterResponse with required fields
    pub fn new(required: UpdateComputeGpuMemoryClusterResponseRequired) -> Self {
        Self {
            etag: required.etag,
