...
/// Required fields for DeleteVtapResponse
pub struct DeleteVtapResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteVtapResponse {
    /// Create a new DeleteVtapResponse with required fields
    pub fn new(required: DeleteVtapResponseRequired) -> Self {
        Self {
