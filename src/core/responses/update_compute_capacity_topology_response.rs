...
pub struct UpdateComputeCapacityTopologyResponse {
...
/// Required fields for UpdateComputeCapacityTopologyResponse
pub struct UpdateComputeCapacityTopologyResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl UpdateComputeCapacityTopologyResponse {
    /// Create a new UpdateComputeCapacityTopologyResponse with required fields
    pub fn new(required: UpdateComputeCapacityTopologyResponseRequired) -> Self {
        Self {
