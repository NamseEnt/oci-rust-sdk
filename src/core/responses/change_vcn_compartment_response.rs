...
pub struct ChangeVcnCompartmentResponse {
...
/// Required fields for ChangeVcnCompartmentResponse
pub struct ChangeVcnCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeVcnCompartmentResponse {
    /// Create a new ChangeVcnCompartmentResponse with required fields
    pub fn new(required: ChangeVcnCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
