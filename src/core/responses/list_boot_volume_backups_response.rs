...
pub struct ListBootVolumeBackupsResponse {
    ...
    pub items: Vec<BootVolumeBackup>,
}


/// Required fields for ListBootVolumeBackupsResponse
pub struct ListBootVolumeBackupsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListBootVolumeBackupsResponse {
    /// Create a new ListBootVolumeBackupsResponse with required fields
    pub fn new(required: ListBootVolumeBackupsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<BootVolumeBackup>) -> Self {
        self.items = value;
        self
    }
}
