...
/// Required fields for UpgradeDrgResponse
pub struct UpgradeDrgResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl UpgradeDrgResponse {
    /// Create a new UpgradeDrgResponse with required fields
    pub fn new(required: UpgradeDrgResponseRequired) -> Self {
        Self {
