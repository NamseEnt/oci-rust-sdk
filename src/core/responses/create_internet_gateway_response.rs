...
impl CreateInternetGatewayResponse {
    /// Create a new CreateInternetGatewayResponse with required fields
    pub fn new(required: CreateInternetGatewayResponseRequired) -> Self {
        Self {
            etag: required.etag,
