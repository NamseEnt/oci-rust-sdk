...
pub struct ListConsoleHistoriesResponse {
    ...
    pub items: Vec<ConsoleHistory>,
}

/// Required fields for ListConsoleHistoriesResponse
pub struct ListConsoleHistoriesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListConsoleHistoriesResponse {
    /// Create a new ListConsoleHistoriesResponse with required fields
    pub fn new(required: ListConsoleHistoriesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<ConsoleHistory>) -> Self {
        self.items = value;
        self
    }
}
