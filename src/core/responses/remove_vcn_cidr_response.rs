...
pub struct RemoveVcnCidrResponse {
...
/// Required fields for RemoveVcnCidrResponse
pub struct RemoveVcnCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl RemoveVcnCidrResponse {
    /// Create a new RemoveVcnCidrResponse with required fields
    pub fn new(required: RemoveVcnCidrResponseRequired) -> Self {
        Self {
