...
pub struct ValidateByoasnResponse {
...
/// Required fields for ValidateByoasnResponse
pub struct ValidateByoasnResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ValidateByoasnResponse {
    /// Create a new ValidateByoasnResponse with required fields
    pub fn new(required: ValidateByoasnResponseRequired) -> Self {
        Self {
