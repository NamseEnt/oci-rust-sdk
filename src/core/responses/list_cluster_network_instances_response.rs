...
pub struct ListClusterNetworkInstancesResponse {
...
/// Required fields for ListClusterNetworkInstancesResponse
pub struct ListClusterNetworkInstancesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListClusterNetworkInstancesResponse {
    /// Create a new ListClusterNetworkInstancesResponse with required fields
    pub fn new(required: ListClusterNetworkInstancesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<InstanceSummary>) -> Self {
        self.items = value;
        self
    }
}
