...
pub struct ListIPSecConnectionsResponse {
    ...
    pub items: Vec<IPSecConnection>,
}

/// Required fields for ListIPSecConnectionsResponse
pub struct ListIPSecConnectionsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListIPSecConnectionsResponse {
    /// Create a new ListIPSecConnectionsResponse with required fields
    pub fn new(required: ListIPSecConnectionsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<IPSecConnection>) -> Self {
        self.items = value;
        self
    }
}
