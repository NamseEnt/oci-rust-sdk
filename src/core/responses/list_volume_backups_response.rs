...
/// Required fields for ListVolumeBackupsResponse
pub struct ListVolumeBackupsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVolumeBackupsResponse {
    /// Create a new ListVolumeBackupsResponse with required fields
    pub fn new(required: ListVolumeBackupsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VolumeBackup>) -> Self {
        self.items = value;
        self
    }
}
