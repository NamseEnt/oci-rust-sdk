...
pub struct DeleteDedicatedVmHostResponse {
...
/// Required fields for DeleteDedicatedVmHostResponse
pub struct DeleteDedicatedVmHostResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteDedicatedVmHostResponse {
    /// Create a new DeleteDedicatedVmHostResponse with required fields
    pub fn new(required: DeleteDedicatedVmHostResponseRequired) -> Self {
        Self {
