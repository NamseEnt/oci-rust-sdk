...
pub struct ListVolumeGroupsResponse {
    ...
    pub items: Vec<VolumeGroup>,
}


/// Required fields for ListVolumeGroupsResponse
pub struct ListVolumeGroupsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVolumeGroupsResponse {
    /// Create a new ListVolumeGroupsResponse with required fields
    pub fn new(required: ListVolumeGroupsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VolumeGroup>) -> Self {
        self.items = value;
        self
    }
}
