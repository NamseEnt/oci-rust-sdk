...
pub struct GetAppCatalogListingResourceVersionResponse {
...
impl GetAppCatalogListingResourceVersionResponse {
    /// Create a new GetAppCatalogListingResourceVersionResponse with required fields
    pub fn new(required: GetAppCatalogListingResourceVersionResponseRequired) -> Self {
        Self {
            etag: required.etag,
