...
pub struct ChangeComputeCapacityTopologyCompartmentResponse {
...
/// Required fields for ChangeComputeCapacityTopologyCompartmentResponse
pub struct ChangeComputeCapacityTopologyCompartmentResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ChangeComputeCapacityTopologyCompartmentResponse {
    /// Create a new ChangeComputeCapacityTopologyCompartmentResponse with required fields
    pub fn new(required: ChangeComputeCapacityTopologyCompartmentResponseRequired) -> Self {
        Self {
