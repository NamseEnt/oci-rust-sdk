...
pub struct CreateComputeGpuMemoryClusterResponse {
...
/// Required fields for CreateComputeGpuMemoryClusterResponse
pub struct CreateComputeGpuMemoryClusterResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl CreateComputeGpuMemoryClusterResponse {
    /// Create a new CreateComputeGpuMemoryClusterResponse with required fields
    pub fn new(required: CreateComputeGpuMemoryClusterResponseRequired) -> Self {
        Self {
            etag: required.etag,
