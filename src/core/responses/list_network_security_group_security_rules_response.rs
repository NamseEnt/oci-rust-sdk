...
pub struct ListNetworkSecurityGroupSecurityRulesResponse {
...
impl ListNetworkSecurityGroupSecurityRulesResponse {
    /// Create a new ListNetworkSecurityGroupSecurityRulesResponse with required fields
    pub fn new(required: ListNetworkSecurityGroupSecurityRulesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<SecurityRule>) -> Self {
        self.items = value;
        self
    }
}
