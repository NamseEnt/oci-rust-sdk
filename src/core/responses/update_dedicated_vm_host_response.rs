...
pub struct UpdateDedicatedVmHostResponse {
...
impl UpdateDedicatedVmHostResponse {
    /// Create a new UpdateDedicatedVmHostResponse with required fields
    pub fn new(required: UpdateDedicatedVmHostResponseRequired) -> Self {
        Self {
            etag: required.etag,
