...
pub struct ListCrossconnectPortSpeedShapesResponse {
...
impl ListCrossconnectPortSpeedShapesResponse {
    /// Create a new ListCrossconnectPortSpeedShapesResponse with required fields
    pub fn new(required: ListCrossconnectPortSpeedShapesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<CrossConnectPortSpeedShape>) -> Self {
        self.items = value;
        self
    }
}
