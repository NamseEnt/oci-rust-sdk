...
pub struct ChangeVtapCompartmentResponse {
...
/// Required fields for ChangeVtapCompartmentResponse
pub struct ChangeVtapCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeVtapCompartmentResponse {
    /// Create a new ChangeVtapCompartmentResponse with required fields
    pub fn new(required: ChangeVtapCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
