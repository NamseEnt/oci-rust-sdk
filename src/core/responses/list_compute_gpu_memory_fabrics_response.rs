...
pub struct ListComputeGpuMemoryFabricsResponse {
...
impl ListComputeGpuMemoryFabricsResponse {
    /// Create a new ListComputeGpuMemoryFabricsResponse with required fields
    pub fn new(required: ListComputeGpuMemoryFabricsResponseRequired) -> Self {
        Self {
