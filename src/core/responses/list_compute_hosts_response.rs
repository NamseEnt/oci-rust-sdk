...
pub struct ListComputeHostsResponse {
...
impl ListComputeHostsResponse {
    /// Create a new ListComputeHostsResponse with required fields
    pub fn new(required: ListComputeHostsResponseRequired) -> Self {
        Self {
    ...
    /// Set compute_host_collection
    pub fn set_compute_host_collection(mut self, value: ComputeHostCollection) -> Self {
        self.compute_host_collection = value;
        self
    }
}
