...
pub struct ListDrgAttachmentsResponse {
    ...
    pub items: Vec<DrgAttachment>,
}


/// Required fields for ListDrgAttachmentsResponse
pub struct ListDrgAttachmentsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDrgAttachmentsResponse {
    /// Create a new ListDrgAttachmentsResponse with required fields
    pub fn new(required: ListDrgAttachmentsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<DrgAttachment>) -> Self {
        self.items = value;
        self
    }
}
