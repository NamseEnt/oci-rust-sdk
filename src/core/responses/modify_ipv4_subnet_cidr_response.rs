...
pub struct ModifyIpv4SubnetCidrResponse {
...
/// Required fields for ModifyIpv4SubnetCidrResponse
pub struct ModifyIpv4SubnetCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ModifyIpv4SubnetCidrResponse {
    /// Create a new ModifyIpv4SubnetCidrResponse with required fields
    pub fn new(required: ModifyIpv4SubnetCidrResponseRequired) -> Self {
        Self {
