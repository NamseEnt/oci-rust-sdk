...
pub struct ListBlockVolumeReplicasResponse {
    ...
    pub items: Vec<BlockVolumeReplica>,
}

/// Required fields for ListBlockVolumeReplicasResponse
pub struct ListBlockVolumeReplicasResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListBlockVolumeReplicasResponse {
    /// Create a new ListBlockVolumeReplicasResponse with required fields
    pub fn new(required: ListBlockVolumeReplicasResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<BlockVolumeReplica>) -> Self {
        self.items = value;
        self
    }
}
