...
pub struct DeleteByoipRangeResponse {
...
/// Required fields for DeleteByoipRangeResponse
pub struct DeleteByoipRangeResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteByoipRangeResponse {
    /// Create a new DeleteByoipRangeResponse with required fields
    pub fn new(required: DeleteByoipRangeResponseRequired) -> Self {
        Self {
