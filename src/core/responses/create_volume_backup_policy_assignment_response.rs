...
pub struct CreateVolumeBackupPolicyAssignmentResponse {
...
impl CreateVolumeBackupPolicyAssignmentResponse {
    /// Create a new CreateVolumeBackupPolicyAssignmentResponse with required fields
    pub fn new(required: CreateVolumeBackupPolicyAssignmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
