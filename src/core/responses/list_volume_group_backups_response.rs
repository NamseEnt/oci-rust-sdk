...
pub struct ListVolumeGroupBackupsResponse {
    ...
    pub items: Vec<VolumeGroupBackup>,
}


/// Required fields for ListVolumeGroupBackupsResponse
pub struct ListVolumeGroupBackupsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVolumeGroupBackupsResponse {
    /// Create a new ListVolumeGroupBackupsResponse with required fields
    pub fn new(required: ListVolumeGroupBackupsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VolumeGroupBackup>) -> Self {
        self.items = value;
        self
    }
}
