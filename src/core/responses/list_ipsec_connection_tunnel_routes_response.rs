...
pub struct ListIPSecConnectionTunnelRoutesResponse {
...
impl ListIPSecConnectionTunnelRoutesResponse {
    /// Create a new ListIPSecConnectionTunnelRoutesResponse with required fields
    pub fn new(required: ListIPSecConnectionTunnelRoutesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<TunnelRouteSummary>) -> Self {
        self.items = value;
        self
    }
}
