...
pub struct UpdateInstanceConfigurationResponse {
...
impl UpdateInstanceConfigurationResponse {
    /// Create a new UpdateInstanceConfigurationResponse with required fields
    pub fn new(required: UpdateInstanceConfigurationResponseRequired) -> Self {
        Self {
            etag: required.etag,
