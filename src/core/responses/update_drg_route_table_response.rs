...
pub struct UpdateDrgRouteTableResponse {
...
impl UpdateDrgRouteTableResponse {
    /// Create a new UpdateDrgRouteTableResponse with required fields
    pub fn new(required: UpdateDrgRouteTableResponseRequired) -> Self {
        Self {
            etag: required.etag,
