...
pub struct ListClusterNetworksResponse {
    ...
    pub items: Vec<ClusterNetworkSummary>,
}

/// Required fields for ListClusterNetworksResponse
pub struct ListClusterNetworksResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListClusterNetworksResponse {
    /// Create a new ListClusterNetworksResponse with required fields
    pub fn new(required: ListClusterNetworksResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<ClusterNetworkSummary>) -> Self {
        self.items = value;
        self
    }
}
