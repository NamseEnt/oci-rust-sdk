...
pub struct ListAppCatalogListingsResponse {
    ...
    pub items: Vec<AppCatalogListingSummary>,
}

/// Required fields for ListAppCatalogListingsResponse
pub struct ListAppCatalogListingsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListAppCatalogListingsResponse {
    /// Create a new ListAppCatalogListingsResponse with required fields
    pub fn new(required: ListAppCatalogListingsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<AppCatalogListingSummary>) -> Self {
        self.items = value;
        self
    }
}
