...
pub struct TerminateClusterNetworkResponse {
...
/// Required fields for TerminateClusterNetworkResponse
pub struct TerminateClusterNetworkResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl TerminateClusterNetworkResponse {
    /// Create a new TerminateClusterNetworkResponse with required fields
    pub fn new(required: TerminateClusterNetworkResponseRequired) -> Self {
        Self {
