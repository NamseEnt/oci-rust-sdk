...
pub struct ChangeDedicatedVmHostCompartmentResponse {
...
/// Required fields for ChangeDedicatedVmHostCompartmentResponse
pub struct ChangeDedicatedVmHostCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeDedicatedVmHostCompartmentResponse {
    /// Create a new ChangeDedicatedVmHostCompartmentResponse with required fields
    pub fn new(required: ChangeDedicatedVmHostCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
