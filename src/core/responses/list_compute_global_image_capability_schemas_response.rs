...
pub struct ListComputeGlobalImageCapabilitySchemasResponse {
...
impl ListComputeGlobalImageCapabilitySchemasResponse {
    /// Create a new ListComputeGlobalImageCapabilitySchemasResponse with required fields
    pub fn new(required: ListComputeGlobalImageCapabilitySchemasResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<ComputeGlobalImageCapabilitySchemaSummary>) -> Self {
        self.items = value;
        self
    }
}
