...
/// Required fields for ListVtapsResponse
pub struct ListVtapsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVtapsResponse {
    /// Create a new ListVtapsResponse with required fields
    pub fn new(required: ListVtapsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<Vtap>) -> Self {
        self.items = value;
        self
    }
}
