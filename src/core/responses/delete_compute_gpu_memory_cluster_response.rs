...
pub struct DeleteComputeGpuMemoryClusterResponse {
...
/// Required fields for DeleteComputeGpuMemoryClusterResponse
pub struct DeleteComputeGpuMemoryClusterResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteComputeGpuMemoryClusterResponse {
    /// Create a new DeleteComputeGpuMemoryClusterResponse with required fields
    pub fn new(required: DeleteComputeGpuMemoryClusterResponseRequired) -> Self {
        Self {
