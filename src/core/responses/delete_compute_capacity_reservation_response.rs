...
pub struct DeleteComputeCapacityReservationResponse {
...
/// Required fields for DeleteComputeCapacityReservationResponse
pub struct DeleteComputeCapacityReservationResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteComputeCapacityReservationResponse {
    /// Create a new DeleteComputeCapacityReservationResponse with required fields
    pub fn new(required: DeleteComputeCapacityReservationResponseRequired) -> Self {
        Self {
