...
pub struct GetTunnelCpeDeviceConfigResponse {
...
impl GetTunnelCpeDeviceConfigResponse {
    /// Create a new GetTunnelCpeDeviceConfigResponse with required fields
    pub fn new(required: GetTunnelCpeDeviceConfigResponseRequired) -> Self {
        Self {
            etag: required.etag,
