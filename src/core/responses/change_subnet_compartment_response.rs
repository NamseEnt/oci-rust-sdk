...
pub struct ChangeSubnetCompartmentResponse {
...
/// Required fields for ChangeSubnetCompartmentResponse
pub struct ChangeSubnetCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeSubnetCompartmentResponse {
    /// Create a new ChangeSubnetCompartmentResponse with required fields
    pub fn new(required: ChangeSubnetCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
