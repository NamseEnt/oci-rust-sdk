...
pub struct PrivateIpVnicDetachResponse {
...
impl PrivateIpVnicDetachResponse {
    /// Create a new PrivateIpVnicDetachResponse with required fields
    pub fn new(required: PrivateIpVnicDetachResponseRequired) -> Self {
        Self {
            etag: required.etag,
