...
pub struct CreateDedicatedVmHostResponse {
...
/// Required fields for CreateDedicatedVmHostResponse
pub struct CreateDedicatedVmHostResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl CreateDedicatedVmHostResponse {
    /// Create a new CreateDedicatedVmHostResponse with required fields
    pub fn new(required: CreateDedicatedVmHostResponseRequired) -> Self {
        Self {
            etag: required.etag,
