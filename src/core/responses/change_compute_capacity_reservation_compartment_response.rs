...
pub struct ChangeComputeCapacityReservationCompartmentResponse {
...
/// Required fields for ChangeComputeCapacityReservationCompartmentResponse
pub struct ChangeComputeCapacityReservationCompartmentResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ChangeComputeCapacityReservationCompartmentResponse {
    /// Create a new ChangeComputeCapacityReservationCompartmentResponse with required fields
    pub fn new(required: ChangeComputeCapacityReservationCompartmentResponseRequired) -> Self {
        Self {
