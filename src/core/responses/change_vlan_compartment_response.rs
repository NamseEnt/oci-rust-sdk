...
pub struct ChangeVlanCompartmentResponse {
...
/// Required fields for ChangeVlanCompartmentResponse
pub struct ChangeVlanCompartmentResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ChangeVlanCompartmentResponse {
    /// Create a new ChangeVlanCompartmentResponse with required fields
    pub fn new(required: ChangeVlanCompartmentResponseRequired) -> Self {
        Self {
