...
/// Required fields for ListDrgsResponse
pub struct ListDrgsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDrgsResponse {
    /// Create a new ListDrgsResponse with required fields
    pub fn new(required: ListDrgsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<Drg>) -> Self {
        self.items = value;
        self
    }
}
