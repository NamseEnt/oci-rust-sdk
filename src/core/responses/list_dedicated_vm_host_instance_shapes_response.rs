...
pub struct ListDedicatedVmHostInstanceShapesResponse {
...
impl ListDedicatedVmHostInstanceShapesResponse {
    /// Create a new ListDedicatedVmHostInstanceShapesResponse with required fields
    pub fn new(required: ListDedicatedVmHostInstanceShapesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<DedicatedVmHostInstanceShapeSummary>) -> Self {
        self.items = value;
        self
    }
}
