...
pub struct ListDrgRouteTablesResponse {
    ...
    pub items: Vec<DrgRouteTable>,
}

/// Required fields for ListDrgRouteTablesResponse
pub struct ListDrgRouteTablesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDrgRouteTablesResponse {
    /// Create a new ListDrgRouteTablesResponse with required fields
    pub fn new(required: ListDrgRouteTablesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<DrgRouteTable>) -> Self {
        self.items = value;
        self
    }
}
