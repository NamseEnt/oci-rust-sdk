...
pub struct ListCaptureFiltersResponse {
    ...
    pub items: Vec<CaptureFilter>,
}


/// Required fields for ListCaptureFiltersResponse
pub struct ListCaptureFiltersResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListCaptureFiltersResponse {
    /// Create a new ListCaptureFiltersResponse with required fields
    pub fn new(required: ListCaptureFiltersResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<CaptureFilter>) -> Self {
        self.items = value;
        self
    }
}
