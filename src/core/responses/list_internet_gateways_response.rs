...
pub struct ListInternetGatewaysResponse {
...
/// Required fields for ListInternetGatewaysResponse
pub struct ListInternetGatewaysResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListInternetGatewaysResponse {
    /// Create a new ListInternetGatewaysResponse with required fields
    pub fn new(required: ListInternetGatewaysResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<InternetGateway>) -> Self {
        self.items = value;
        self
    }
}
