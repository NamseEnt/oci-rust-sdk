...
pub struct ListInstanceDevicesResponse {
...
/// Required fields for ListInstanceDevicesResponse
pub struct ListInstanceDevicesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListInstanceDevicesResponse {
    /// Create a new ListInstanceDevicesResponse with required fields
    pub fn new(required: ListInstanceDevicesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<Device>) -> Self {
        self.items = value;
        self
    }
}
