...
pub struct ListDedicatedVmHostsResponse {
    ...
    pub items: Vec<DedicatedVmHostSummary>,
}

/// Required fields for ListDedicatedVmHostsResponse
pub struct ListDedicatedVmHostsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDedicatedVmHostsResponse {
    /// Create a new ListDedicatedVmHostsResponse with required fields
    pub fn new(required: ListDedicatedVmHostsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<DedicatedVmHostSummary>) -> Self {
        self.items = value;
        self
    }
}
