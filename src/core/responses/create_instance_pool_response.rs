...
/// Required fields for CreateInstancePoolResponse
pub struct CreateInstancePoolResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl CreateInstancePoolResponse {
    /// Create a new CreateInstancePoolResponse with required fields
    pub fn new(required: CreateInstancePoolResponseRequired) -> Self {
        Self {
            etag: required.etag,
