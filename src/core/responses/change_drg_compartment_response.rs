...
pub struct ChangeDrgCompartmentResponse {
...
/// Required fields for ChangeDrgCompartmentResponse
pub struct ChangeDrgCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeDrgCompartmentResponse {
    /// Create a new ChangeDrgCompartmentResponse with required fields
    pub fn new(required: ChangeDrgCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
