...
pub struct ListVnicAttachmentsResponse {
    ...
    pub items: Vec<VnicAttachment>,
}

/// Required fields for ListVnicAttachmentsResponse
pub struct ListVnicAttachmentsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVnicAttachmentsResponse {
    /// Create a new ListVnicAttachmentsResponse with required fields
    pub fn new(required: ListVnicAttachmentsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VnicAttachment>) -> Self {
        self.items = value;
        self
    }
}
