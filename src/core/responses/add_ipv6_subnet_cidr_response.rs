...
pub struct AddIpv6SubnetCidrResponse {
...
impl AddIpv6SubnetCidrResponse {
    /// Create a new AddIpv6SubnetCidrResponse with required fields
    pub fn new(required: AddIpv6SubnetCidrResponseRequired) -> Self {
        Self {
            etag: required.etag,
