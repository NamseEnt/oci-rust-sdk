...
pub struct ChangeComputeHostGroupCompartmentResponse {
...
/// Required fields for ChangeComputeHostGroupCompartmentResponse
pub struct ChangeComputeHostGroupCompartmentResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl ChangeComputeHostGroupCompartmentResponse {
    /// Create a new ChangeComputeHostGroupCompartmentResponse with required fields
    pub fn new(required: ChangeComputeHostGroupCompartmentResponseRequired) -> Self {
        Self {
