...
pub struct ListCrossConnectGroupsResponse {
    ...
    pub items: Vec<CrossConnectGroup>,
}


/// Required fields for ListCrossConnectGroupsResponse
pub struct ListCrossConnectGroupsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListCrossConnectGroupsResponse {
    /// Create a new ListCrossConnectGroupsResponse with required fields
    pub fn new(required: ListCrossConnectGroupsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<CrossConnectGroup>) -> Self {
        self.items = value;
        self
    }
}
