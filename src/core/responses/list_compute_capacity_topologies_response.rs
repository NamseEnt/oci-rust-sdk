...
pub struct ListComputeCapacityTopologiesResponse {
...
impl ListComputeCapacityTopologiesResponse {
    /// Create a new ListComputeCapacityTopologiesResponse with required fields
    pub fn new(required: ListComputeCapacityTopologiesResponseRequired) -> Self {
        Self {
