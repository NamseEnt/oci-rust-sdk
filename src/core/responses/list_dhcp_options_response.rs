...
pub struct ListDhcpOptionsResponse {
    ...
    pub items: Vec<DhcpOptions>,
}

/// Required fields for ListDhcpOptionsResponse
pub struct ListDhcpOptionsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDhcpOptionsResponse {
    /// Create a new ListDhcpOptionsResponse with required fields
    pub fn new(required: ListDhcpOptionsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<DhcpOptions>) -> Self {
        self.items = value;
        self
    }
}
