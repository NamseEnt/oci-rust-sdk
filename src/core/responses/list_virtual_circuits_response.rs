...
pub struct ListVirtualCircuitsResponse {
    ...
    pub items: Vec<VirtualCircuit>,
}


/// Required fields for ListVirtualCircuitsResponse
pub struct ListVirtualCircuitsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListVirtualCircuitsResponse {
    /// Create a new ListVirtualCircuitsResponse with required fields
    pub fn new(required: ListVirtualCircuitsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<VirtualCircuit>) -> Self {
        self.items = value;
        self
    }
}
