...
/// Required fields for LaunchInstanceConfigurationResponse
pub struct LaunchInstanceConfigurationResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl LaunchInstanceConfigurationResponse {
    /// Create a new LaunchInstanceConfigurationResponse with required fields
    pub fn new(required: LaunchInstanceConfigurationResponseRequired) -> Self {
        Self {
            etag: required.etag,
