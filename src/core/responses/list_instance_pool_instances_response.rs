...
pub struct ListInstancePoolInstancesResponse {
...
/// Required fields for ListInstancePoolInstancesResponse
pub struct ListInstancePoolInstancesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListInstancePoolInstancesResponse {
    /// Create a new ListInstancePoolInstancesResponse with required fields
    pub fn new(required: ListInstancePoolInstancesResponseRequired) -> Self {
        Self {
