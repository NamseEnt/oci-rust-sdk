...
pub struct DetachComputeHostGroupHostResponse {
...
/// Required fields for DetachComputeHostGroupHostResponse
pub struct DetachComputeHostGroupHostResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DetachComputeHostGroupHostResponse {
    /// Create a new DetachComputeHostGroupHostResponse with required fields
    pub fn new(required: DetachComputeHostGroupHostResponseRequired) -> Self {
        Self {
