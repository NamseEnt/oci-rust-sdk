...
pub struct CreateComputeCapacityTopologyResponse {
...
impl CreateComputeCapacityTopologyResponse {
    /// Create a new CreateComputeCapacityTopologyResponse with required fields
    pub fn new(required: CreateComputeCapacityTopologyResponseRequired) -> Self {
        Self {
            etag: required.etag,
