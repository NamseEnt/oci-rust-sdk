...
impl ListIpv6sResponse {
    /// Create a new ListIpv6sResponse with required fields
    pub fn new(required: ListIpv6sResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<Ipv6>) -> Self {
        self.items = value;
        self
    }
}
