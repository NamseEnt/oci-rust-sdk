...
pub struct DeleteComputeCapacityTopologyResponse {
...
/// Required fields for DeleteComputeCapacityTopologyResponse
pub struct DeleteComputeCapacityTopologyResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl DeleteComputeCapacityTopologyResponse {
    /// Create a new DeleteComputeCapacityTopologyResponse with required fields
    pub fn new(required: DeleteComputeCapacityTopologyResponseRequired) -> Self {
        Self {
