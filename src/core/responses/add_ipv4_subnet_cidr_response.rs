...
pub struct AddIpv4SubnetCidrResponse {
...
/// Required fields for AddIpv4SubnetCidrResponse
pub struct AddIpv4SubnetCidrResponseRequired {
    /// Unique Oracle-assigned identifier for the request. If you need to contact Oracle about a particular request, please provide the request ID.
    pub opc_request_id: String,
...
impl AddIpv4SubnetCidrResponse {
    /// Create a new AddIpv4SubnetCidrResponse with required fields
    pub fn new(required: AddIpv4SubnetCidrResponseRequired) -> Self {
        Self {
