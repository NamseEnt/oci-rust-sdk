...
pub struct ListCpeDeviceShapesResponse {
    ...
    pub items: Vec<CpeDeviceShapeSummary>,
}

/// Required fields for ListCpeDeviceShapesResponse
pub struct ListCpeDeviceShapesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListCpeDeviceShapesResponse {
    /// Create a new ListCpeDeviceShapesResponse with required fields
    pub fn new(required: ListCpeDeviceShapesResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<CpeDeviceShapeSummary>) -> Self {
        self.items = value;
        self
    }
}
