...
pub struct ChangeInstanceCompartmentResponse {
...
/// Required fields for ChangeInstanceCompartmentResponse
pub struct ChangeInstanceCompartmentResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl ChangeInstanceCompartmentResponse {
    /// Create a new ChangeInstanceCompartmentResponse with required fields
    pub fn new(required: ChangeInstanceCompartmentResponseRequired) -> Self {
        Self {
            etag: required.etag,
