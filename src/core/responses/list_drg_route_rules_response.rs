...
pub struct ListDrgRouteRulesResponse {
...
/// Required fields for ListDrgRouteRulesResponse
pub struct ListDrgRouteRulesResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListDrgRouteRulesResponse {
    /// Create a new ListDrgRouteRulesResponse with required fields
    pub fn new(required: ListDrgRouteRulesResponseRequired) -> Self {
        Self {
