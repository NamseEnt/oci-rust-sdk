...
pub struct AttachComputeHostGroupHostResponse {
...
impl AttachComputeHostGroupHostResponse {
    /// Create a new AttachComputeHostGroupHostResponse with required fields
    pub fn new(required: AttachComputeHostGroupHostResponseRequired) -> Self {
        Self {
            etag: required.etag,
