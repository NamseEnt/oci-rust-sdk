...
pub struct ListNatGatewaysResponse {
...
impl ListNatGatewaysResponse {
    /// Create a new ListNatGatewaysResponse with required fields
    pub fn new(required: ListNatGatewaysResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<NatGateway>) -> Self {
        self.items = value;
        self
    }
}
