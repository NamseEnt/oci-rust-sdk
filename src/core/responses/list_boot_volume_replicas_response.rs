...
pub struct ListBootVolumeReplicasResponse {
    ...
    pub items: Vec<BootVolumeReplica>,
}


/// Required fields for ListBootVolumeReplicasResponse
pub struct ListBootVolumeReplicasResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListBootVolumeReplicasResponse {
    /// Create a new ListBootVolumeReplicasResponse with required fields
    pub fn new(required: ListBootVolumeReplicasResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<BootVolumeReplica>) -> Self {
        self.items = value;
        self
    }
}
