...
pub struct ListPrivateIpsResponse {
    ...
    pub items: Vec<PrivateIp>,
}

/// Required fields for ListPrivateIpsResponse
pub struct ListPrivateIpsResponseRequired {
    /// For list pagination. When this header appears in the response, additional pages of results remain. For important details about how pagination works, see [List Pagination](https://docs.oracle.com/iaas/Content/API/Concepts/usingapi.htm#nine).
    pub opc_next_page: String,
...
impl ListPrivateIpsResponse {
    /// Create a new ListPrivateIpsResponse with required fields
    pub fn new(required: ListPrivateIpsResponseRequired) -> Self {
        Self {
    ...
    /// Set items
    pub fn set_items(mut self, value: Vec<PrivateIp>) -> Self {
        self.items = value;
        self
    }
}
