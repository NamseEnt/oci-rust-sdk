...
pub struct CreateComputeHostGroupResponse {
...
/// Required fields for CreateComputeHostGroupResponse
pub struct CreateComputeHostGroupResponseRequired {
    /// For optimistic concurrency control. See {@code if-match}.
    pub etag: String,
...
impl CreateComputeHostGroupResponse {
    /// Create a new CreateComputeHostGroupResponse with required fields
    pub fn new(required: CreateComputeHostGroupResponseRequired) -> Self {
        Self {
            etag: required.etag,
