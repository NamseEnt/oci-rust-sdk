...
/// Required fields for UpdateContainerResponse
pub struct UpdateContainerResponseRequired {
    /// Unique Oracle-assigned identifier for the asynchronous request. You can use this to query status of the asynchronous operation.
    pub opc_work_request_id: String,
...
impl UpdateContainerResponse {
    /// Create a new UpdateContainerResponse with required fields
    pub fn new(required: UpdateContainerResponseRequired) -> Self {
        Self {
