...
pub struct ListWorkRequestLogsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sort_by: Option<ListWorkRequestLogsRequestSortBy>,
...
/// Required fields for ListWorkRequestLogsRequest
pub struct ListWorkRequestLogsRequestRequired {
    /// The ID of the asynchronous request.
    pub work_request_id: String,
}

impl ListWorkRequestLogsRequest {
    /// Create a new ListWorkRequestLogsRequest with required fields
    pub fn new(required: ListWorkRequestLogsRequestRequired) -> Self {
        Self {
    ...
    /// Set sort_by
    pub fn set_sort_by(mut self, value: Option<ListWorkRequestLogsRequestSortBy>) -> Self {
        self.sort_by = value;
        self
    }
    ...
    pub fn with_sort_by(mut self, value: ListWorkRequestLogsRequestSortBy) -> Self {
