...
pub struct ListContainerInstanceShapesRequest {
...
impl ListContainerInstanceShapesRequest {
    /// Create a new ListContainerInstanceShapesRequest with required fields
    pub fn new(required: ListContainerInstanceShapesRequestRequired) -> Self {
        Self {
