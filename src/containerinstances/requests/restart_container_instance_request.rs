...
pub struct RestartContainerInstanceRequest {
...
/// Required fields for RestartContainerInstanceRequest
pub struct RestartContainerInstanceRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container instance.
    pub container_instance_id: String,
}

impl RestartContainerInstanceRequest {
    /// Create a new RestartContainerInstanceRequest with required fields
    pub fn new(required: RestartContainerInstanceRequestRequired) -> Self {
        Self {
