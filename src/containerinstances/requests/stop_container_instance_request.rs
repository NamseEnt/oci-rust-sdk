...
pub struct StopContainerInstanceRequest {
...
impl StopContainerInstanceRequest {
    /// Create a new StopContainerInstanceRequest with required fields
    pub fn new(required: StopContainerInstanceRequestRequired) -> Self {
        Self {
