...
pub struct StartContainerInstanceRequest {
...
/// Required fields for StartContainerInstanceRequest
pub struct StartContainerInstanceRequestRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container instance.
    pub container_instance_id: String,
}

impl StartContainerInstanceRequest {
    /// Create a new StartContainerInstanceRequest with required fields
    pub fn new(required: StartContainerInstanceRequestRequired) -> Self {
        Self {
